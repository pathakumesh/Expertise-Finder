...
class ExpertsExtractPipeline(object):
    def __init__(self):
        self.files = {}
        self.file_name = 'U at Albany SUNY.csv'
        self.export_fields = ["name","title", "faculty", "department",
        "phone","email","biography_intro","biography_full","headshot", "faculty_page",
        ...
        "areas_of_expertise_14","areas_of_expertise_15","areas_of_expertise_16","areas_of_expertise_17"]
