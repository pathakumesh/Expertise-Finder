...
class ExpertsExtractItem(scrapy.Item):
    ...
    areas_of_expertise_18 = scrapy.Field()
    areas_of_expertise_19 = scrapy.Field()
    areas_of_expertise_20 = scrapy.Field()
    areas_of_expertise_21 = scrapy.Field()
    areas_of_expertise_22 = scrapy.Field()
