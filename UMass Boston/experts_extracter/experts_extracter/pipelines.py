...
class ExpertsExtractPipeline(object):
    def __init__(self):
        self.files = {}
        self.file_name = 'umass_data.csv'
        self.export_fields = ["name","title_1","title_2","title_3","title_4","department", "phone","email","additional_info",
        "headshot","website","faculty_page",
        ...
        "areas_of_expertise_13","areas_of_expertise_14","areas_of_expertise_15","areas_of_expertise_16",
        "areas_of_expertise_17","areas_of_expertise_18","areas_of_expertise_19","areas_of_expertise_20",
        "areas_of_expertise_21"]
