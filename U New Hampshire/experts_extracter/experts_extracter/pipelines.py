...
class ExpertsExtractPipeline(object):
    def __init__(self):
        self.files = {}
        self.file_name = 'University of New Hampshire.csv'
        self.export_fields = ["name","title","biography", "college", "department","email",
        "office_contact","personal_contact","faculty_page", "headshot","personal_site",
        ...
        "areas_of_expertise_9","areas_of_expertise_10","areas_of_expertise_11"]
